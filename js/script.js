document.addEventListener('DOMContentLoaded', function () {
    ...
    function mostrarPopUp(producto) {
        ...
        popUp.classList.add('pop-up', 'animate__animated', 'animate__fadeIn');
        popUp.innerHTML = `
            <div class="pop-up-content">
                <img src="${producto.imagenSrc}" alt="${producto.titulo}">
                <h2>${producto.titulo}</h2>
                <p>${producto.descripcion}</p>
                <h3>Precio: $${producto.precio.toFixed(2)}</h3>
    ...
    function mostrarMensajeConfirmacion() {
        ...
        popUpConfirmacion.classList.add('pop-up', 'animate__animated', 'animate__fadeIn');
        ...
        setTimeout(() => {
            popUpConfirmacion.classList.remove('animate__fadeIn');
            popUpConfirmacion.classList.add('animate__fadeOut');
